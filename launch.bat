...
echo ============================================
echo.
echo [4] Iniciar todos los servicios (dev)
echo [5] Iniciar todos los servicios (test)
echo [6] Compilar microservicios
echo [7] Reinstalar dependencias Maven
echo.
echo --- Servicios individuales ---
echo [8] Iniciar Eureka
echo [9] Iniciar ms-destinos
echo [10] Iniciar ms-reservas
echo [11] Iniciar ms-usuarios
echo [12] Iniciar ms-hoteles
echo [13] Iniciar ms-vuelos
echo [14] Iniciar ms-auth
echo [15] Iniciar ms-notificaciones
echo [16] Iniciar ms-pagos
echo [17] Iniciar ms-resennas
echo [18] Iniciar ms-reportes
echo [19] Iniciar API Gateway
echo.
echo  Salir
echo.
echo ============================================
...
echo Todos los servicios han sido lanzados. [2, 20]
pause
goto MENU
...
echo.
echo Compilacion global completada. [3]
pause
goto MENU
